        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "note_id": {
                        "type": "string",
                        "description": "The ID of the note to process"
                    },
                    "steps": {
                        "type": "array",
                        "items": {
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "link_type": {
                        "type": "string",
                        "enum": ["supports", "refines", "extends", "contradicts", "is_example_of", "related"],
        ...
        if name == "zk_create_note":
            ...
            try:
                ...
                if not note:
                    return [types.TextContent(
                        type="text",
                        text=json.dumps({"success": False, "error": f"Note {note_id} not found"})
                    )]
            ...
            try:
                ...
                if not source_note:
                    return [types.TextContent(
                        type="text",
                        text=json.dumps({"success": False, "error": f"Source note {source_id} not found"})
                    )]
                    
                if not target_note:
                    return [types.TextContent(
                        type="text", 
                        text=json.dumps({"success": False, "error": f"Target note {target_id} not found"})
                    )]
